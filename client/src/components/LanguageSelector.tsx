...
const LanguageSelector = () => {
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger className="flex items-center gap-2 text-sm focus:outline-none text-gray-800 hover:text-[#3B82F6] dark:text-white dark:hover:text-[#3B82F6] transition-all duration-300 p-2 rounded-lg border border-gray-300 dark:border-white/20 hover:border-[#3B82F6] hover:bg-gray-100 dark:hover:bg-white/10 group hover-lift hover-scale">
